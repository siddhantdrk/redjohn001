...
class SchedulesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root: View = inflater.inflate(R.layout.fragment_schedules, container, false)
        val tabLayout: TabLayout = root.findViewById(R.id.schedule_tab_layout)
        tabLayout.setTabWidthAsWrapContent(0)
        tabLayout.setTabWidthAsWrapContent(1)
        return root
    }

    // function for making the tab width in tab layout to be wrap_content
